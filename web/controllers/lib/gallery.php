...
if (current_theme_supports('bootstrap-gallery')) {
  ...
  add_shortcode('gallery', 'ungarh_gallery');
 ...
 */
function ungarh_attachment_link_class($html) {
  $html = str_replace('<a', '<a class="thumbnail img-thumbnail"', $html);
  return $html;
}
add_filter('wp_get_attachment_link', 'ungarh_attachment_link_class', 10, 1);
